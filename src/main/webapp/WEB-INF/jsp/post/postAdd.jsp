...
<section id="banner" data-video="images/banner">
    <div class="inner">
        <h1>Food Travel</h1>
        <h2 style="color: #FFF;">Post Add</h2>
    </div>
</section>
        ...
        <form id="tmpSendFrm" method="post" enctype="multipart/form-data">
            <div class="row uniform">
                <div class="12u$" style="color: black">
                    <h4>제목을 입력해주세요!</h4>
                    <input type="text" name="title" id="title" value="" placeholder="제목" STYLE="font-family: test_name">
                </div>
            </div>
            ...
            <div class="row uniform">
                <div class="12u$" style="color: black">
                    ...
                    <textarea name="content" id="content" placeholder="내용을 입력해주세요!" rows="6"
                              STYLE="font-family: test_name"></textarea>
                </div>
            </div>
            ...
            <div class="row uniform">
                <ul class="12u$" style="color: black">
                    ...
                    <a onclick="sample5_execDaumPostcode()" class="button special icon fa-search" style="float: right; font-family: test_name">주소
                        검색</a>
                </ul>
                <div class="12u$">
                    <div id="map" style="width:100%;height:300px;margin-top:10px;display:none;"></div>
                    <input type="text" readonly name="area" id="area" style="display:none; margin-top: 2%; font-family: test_name">
            ...
            <div class="row uniform">
                <!-- Break -->
                <div class="12u$">
                    <input type="button" value="작성 하기" style="background: #5AA6ED; float: right; font-family: test_name" onclick="post_add()">
                </div>
            </div>
        </form>
    </div>
    ...
    function file_add(){
        if ( fileCount < 5 ){
            ...
            var str = "<div id='file"+fileCount+"' style='margin-top: 4%'><input type='file' id='file"+ fileCount+ "' name='fileList' class='upload-hidden'>" +
                "<a href='#this' id='file"+fileCount+"' name='file-delete' onclick='deleteTest()'>삭제</a><span class='image fit' style='margin-top: 4%;'><img id='file"+fileCount+"' src='' style='display:none'></span></div>";
